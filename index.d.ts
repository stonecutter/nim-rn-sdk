...
declare namespace NIM_SDK {
  export function usePlugin({ db: any }: { db: any }): void
  ...
  class NIM {
     ...
     */
    public addTeamManagers(addTeamManagersOptions: AddTeamManagersOptions): void
